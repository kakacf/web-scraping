...
// data
got.get('https://www.hdlife.com.tw/Browsing/LivingRoom/Sofa/SofaL/20/4', {
    // TODO: retry
    // retry: 0
  }).then(response => {

        console.log('dom~1~', response.body);
        const dom = new JSDOM(response.body);
        console.log('dom~2~', dom.window.document);
    ...
    //     const dom = new JSDOM(response.body);
    //     console.log('dom~1~', dom.window.document.querySelector("view"));
    //     // console.log('dom~2~', dom.window.document.querySelector("p").textContent);
